...
//        System.out.print("Hello user, I am java");
//    }
//}
...
class Main{
    public static void main(String[] args) {
        ...
        System.out.printf("%s%n", Account.translit("Анастасія"));
        System.out.printf("%s%n", Account.translit("Едуард"));
        System.out.printf("%s%n", Account.translit("Степан"));
        System.out.printf("%s%n", Account.translit("Панас"));
    }
}