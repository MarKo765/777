...
public class TestRegEx
{
    public static void main(String[] args) {
        String exItem ="\t\t<item\n>"+
			...
			"\t\t\t</media:content>\n"+
			"\t\t\t<description><![CDATA[<div><img src=\"https://stat.gov.pl//gfx/portalinformacyjny/_thumbs/pl/defaultaktualnosci/5866/101/1/1/spis_powszechny_1921,k1uUwl-caFOE6tCTiHtf.jpg\"" +
				" alt=\"\" width=\"280\" height=\"212\"/></div>]]></description>\n"+
		"\t\t</item>";
